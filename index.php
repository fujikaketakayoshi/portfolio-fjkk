    ...
    <div class="block-main">
        ...
        <div class="box-profile">
            ...
            <div class="item-list">
                ...
                <p>主にサーバサイドの開発をやりますが、jQueryぐらいなら何とかJavaScriptもやれます。Rubyは経験ありますが、Railsは未経験です。PHPをメイン言語としております。HTML作成からWebAPI叩きまでPHPです。フレームワークはLaravel勉強中、vueとかは未着手です。CakePHPも経験ありますが、1なのでもう古い。SEっぽいこともできるようですし、リプレースの案件とか得意な気もします。</p>
                <ul class="icon-list">
                    <li>
